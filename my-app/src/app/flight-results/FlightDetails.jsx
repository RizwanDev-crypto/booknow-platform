...
export default function FlightDetails({ onClose, selectedFlightData, flightType }) {
          ...
          <>
            ...
            {flightType === 'Round Trip' && (
              <>
                ...
                {/* Route Header Box - Return */}
                <Box sx={{ 
                  bgcolor: "#F0FDF4", // Light green for return
                  p: 2, 
                  borderRadius: 2, 
                  display: "flex", 
                  flexDirection: { xs: "column", sm: "row" },
                  ...
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                    <FlightLandIcon sx={{ fontSize: "1.5rem", color: "#4ADE80" }} />
                    <Box>
                      <Typography sx={{ color: "#1F2937", fontWeight: 600, fontSize: "0.7rem" }}>
                  ...
                  <Box sx={{ textAlign: { xs: "left", sm: "right" }, width: { xs: "100%", sm: "auto" } }}>
                    <Typography variant="caption" sx={{ color: "#6B7280", display: "block", fontSize: "0.6rem" }}>Duration</Typography>
                    <Typography sx={{ color: "#1F2937", fontSize: "0.7rem", fontWeight: 600 }}>5h 55m</Typography>
                  </Box>
                </Box>
                ...
                <Box sx={{ mb: 3, display: "flex", alignItems: "center", gap: 2 }}>
                  <Typography sx={{ 
                    ...
                    {flight.airline} • {flight.flightNumber.replace(/\d+/, (m) => parseInt(m) + 1)}
                  </Typography>
                  <Box sx={{ flex: 1, height: "1px", bgcolor: "#E5E7EB" }} />
                </Box>

                {/* Timeline Section - Return */}
                <Box sx={{ position: "relative", pl: 0 }}>
                  <Box sx={{ 
                    position: "absolute", 
                    left: 9, 
                    ...
                    <Box sx={{ 
                      ...
                      <Box>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1 }}>
                          ...
                          <Box>
                            <Typography sx={{ color: "#111827", fontSize: "0.7em", fontWeight: 600}}>{flight.airline}</Typography>
                            <Typography variant="caption" sx={{ color: "#6B7280", fontSize: "0.6rem" }}>Flight {flight.flightNumber.replace(/\d+/, (m) => parseInt(m) + 1)}</Typography>
                          </Box>
                        </Box>
                        <Box>
                          <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1, }}>
                            ...
                            <Box>
                              <Typography variant="caption" sx={{ color: "#6B7280", display: "block",fontSize: "0.6rem" }}>Duration</Typography>
                              <Typography sx={{ color: "#111827", fontSize: "0.7em", fontWeight: 600 }}>5h 55m</Typography>
                            </Box>
                          </Box>
                          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            <WorkOutlineIcon sx={{ color: "#6B7280", fontSize: "0.8rem" }} />
                      ...
                      <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center", gap: 1 }}>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                          <EventSeatIcon sx={{ color: "#6B7280", fontSize: "0.8rem" }} />
                          <Box>
                            <Typography variant="caption" sx={{ color: "#6B7280", display: "block" }}>Class</Typography>
                            <Typography sx={{ color: "#1F2937", fontSize: "0.7rem", fontWeight: 600 }}>{flight.cabin}</Typography>
                          </Box>
                        </Box>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                          <LuggageIcon sx={{ color: "#6B7280", fontSize: "0.8rem" }} />
                          <Typography sx={{ color: "#6B7280", fontSize: "0.6rem" }}>Check-in: {flight.checkinBaggage}</Typography>
                        </Box>
                      </Box>
                    </Box>
                  </Box>
                  ...
                  <Box sx={{ display: "flex", gap: 2, position: "relative", zIndex: 1 }}>
                    ...
                    <Box sx={{ flex: 1, bgcolor: "#F9FAFB", p: 1.5, borderRadius: 2, border: "1px solid #E5E7EB" }}>
                      <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 0.5 }}>
                          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            <FlightLandIcon sx={{ fontSize: "1rem", color: "#16A34A" }} />
                            <Typography sx={{ color: "#6B7280", fontSize: "0.6rem", fontWeight: 600 }}>ARRIVAL</Typography>
                          </Box>
                          <Box sx={{ 
                            bgcolor: "#DCFCE7", 
