...
export default function AgentSignupPage() {
  ...
  const handleSubmit = (e) => {
    ...
    alert('Agent account created successfully! You can now login.');
    router.push('/login');
  };
      ...
      >
        ...
        >
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', mb: 2 }}>
            ...
            >
              <BusinessCenterOutlinedIcon sx={{ color: '#10b981', fontSize: 24 }} />
            </Box>
          </Box>
          ...
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            ...
            <Typography variant="body2" sx={{ color: '#64748b' }}>
              Register your travel agency to continue
            </Typography>
          </Box>
